...
public @interface Traceable {
	...
	/**
	 * @return The {@link Level} used to print the messages.
	 * By default it's used {@link Level#INFO}.
	 */
    Level level() default DEBUG;

	/**
     * @return The {@link Level} used to print the messages when an invocation starts.
     * When it's not declared, the generic {@link Traceable#level()} is used.
     */
	Level levelStart() default NULL;

	/**
     * @return The {@link Level} used to print the messages when an invocation ends.
     * When it's not declared, the generic {@link Traceable#level()} is used.
     */
	Level levelEnd() default NULL;

    /** @return Flag to print the output value in "start" logs */
    boolean printInput() default true;

	/**
	 * @return The 0-index input arguments to be printed in logs. By default all input arguments are printed.
	 */
    int[] inputArgsIndex() default {};

	/** @return Flag to print the output value in "end" logs */
